...
<body>
  ...
  <div class="container blur-filter">
    ...
    <main>
      <div class="product">
        <img src="../Shared/Images/PlaneGreen.jpg" alt="productimage plane Wow's green">
        <h3 class="product-name">Green Plane</h3>
        <h4 class="product-company">Wow's</h4>
        <div class="buttons">
